...
void trojanConstruct(Proxy &node, const std::string &group, const std::string &remarks, const std::string &server, const std::string &port, const std::string &password, const std::string &net, const std::string &mode, const std::string &host, const std::string &path, const std::string &fp, const std::string &flow, const std::string &tls, const std::string &sni, tribool udp, tribool tfo, tribool scv, tribool tls13);
